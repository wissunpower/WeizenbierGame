...
const char descriptor_table_protodef_adapter_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ownMessageType\020\000\022\017\n\013ChatRequest\020\n\022\020\n\014Cha"
  "tResponse\020\013\022\024\n\020ChatNotification\020\014b\006proto"
  "3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_adapter_2eproto = {
  false, false, 281, descriptor_table_protodef_adapter_2eproto, "adapter.proto", 
